...
export const GET_INVENTORY_MODEL_BY_ID = "GET_INVENTORY_MODEL_BY_ID";
...
export const GET_INVENTORIES_BY_PARAMS = "GET_INVENTORIES_BY_PARAMS";
export const GET_INVENTORIES_BY_SEARCH = "GET_INVENTORIES_BY_SEARCH";
export const GET_INVENTORY_FIELDS = "GET_INVENTORY_FIELDS";
export const GET_INVENTORY_FIELD_BY_ID = "GET_INVENTORY_FIELD_BY_ID";
export const POST_INVENTORY_FIELD = "POST_INVENTORY_FIELD";
export const PATCH_INVENTORY_FIELD = "PATCH_INVENTORY_FIELD";
export const DELETE_INVENTORY_FIELD = "DELETE_INVENTORY_FIELD";
export const GET_INVENTORY_GROUPS = "GET_INVENTORY_GROUPS";
export const GET_INVENTORY_GROUP = "GET_INVENTORY_GROUP";
